...
describe('My Enumeration Library', function() {
  ...
  xit('should be able to check if every element in an array meets a condition (if there is a film from 2018)', function() {
  ...
  xit('should be able to check if none of the elements in an array meet a condition (if there is a film from 2012)', function() {
    const checkFor2018Film = (film) => {
  ...
  xit('should be able to check if every element in an array meets a condition (if every film is over 60 minutes in length)', function() {
  ...
  xit('should be able to check if not every element in an array meets a condition (if every film is over 150 minutes in length)', function() {
